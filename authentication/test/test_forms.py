...
class AuthenticationFormTest(TestCase):
	...
	def test_edit_address_form_label(self):
		...
		self.assertTrue(
			form.fields['fullname'].label == "Nom complet"
			and form.fields['country'].label == "Pays"
			and form.fields['phone_number'].label == "Numéro de téléphone"
			and form.fields['address1'].label == "Adresse ligne 1"
			and form.fields['address2'].label == "Adresse ligne 2"
			and form.fields['postcode'].label == "Code postal"
			and form.fields['city'].label == "Ville"
		)
